            ...
            <div className='footer-top__payments'>
              ...
              <ul>
                {paymentMethods.map((payment, index) => (
                  <li key={index}>
                    <img width="50px" height="30px" style={{"background-color":"#eee"}} src={payment.icon} className='js-img' alt='' />
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className='footer-nav__col'>
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href='mailto:info@denshop.com'>info@denshop.com</a>
                </li>
              </ul>
            </div>
          </div>
          <div className='footer-copy'>
            <span>&copy; All rights reserved. DenShop 2022</span>
          </div>
        </div>
      </footer>
      {/* <!-- FOOTER EOF   --> */}
